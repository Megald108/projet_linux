...
#
# Corrige les points soulevés dans Critiques.txt sur ATDP3 :
...
#   --sha256=HASH    Vérifie le SHA256 de l'archive téléchargée avant extraction
#
# =========================================================
...
if [ "$#" -lt 1 ]; then
    echo "Usage: $0 <URL_archive> [--verbose|--quiet] [--clean|--no-clean]"
...
# =========================================================
# Étape 3 : Téléchargement + vérification
# =========================================================
